        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r  from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">
                    Hi, I'm Tsvetalin Hristov
                </h1>

                <p className="text-gray-400 text-lg mb-12 max-w-lg mx-auto">
                    Software developer & computer science student passionate about developing and delivering modern software solutions for your business.
                </p>

                <div className="flex justify-center space-x-4">

                    <a href="#prjects" className="bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative 
